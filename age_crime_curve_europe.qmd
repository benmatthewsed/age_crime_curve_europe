...
-   In the future - possibly extend this analysis to include other countries to help understand how far we can generalize findings from these countries 
...
-   PCLM models convictions data and population data together to estimate a smooth surface of conviction rates, so you probably shouldn't look for disruptions in the time series (policy shocks or what have you)
...
-   So perhaps this does fit better with a youth-focused explanation for the crime drop?
